...
ROOT_DIR = BASE_DIR
sys.path.append(os.path.join(ROOT_DIR, 'backbone_lcasa_pdsa'))

from utils import get_scheduler, setup_logger
from detect_pipline import GroupFreeDetector, get_loss
from detect_pipline import APCalculator, parse_predictions, parse_groundtruths
